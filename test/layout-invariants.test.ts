...
export const TS_TODAY: Record<string, string> = {
  ...
  "demux_2bit_1to2 opaque": "demux_2bit_1to2 opaque I0=0 I1=0 I2=1 I3=0 X=12 B=26 S=3/13 size=42x21",
  "demux_3bit_1to2 opaque": "demux_3bit_1to2 opaque I0=5 I1=8 I2=12 I3=0 X=18 B=45 S=2/19 size=42x31",
  ...
  "full_adder_from_builtins expanded": "full_adder_from_builtins expanded I0=0 I1=6 I2=15 I3=0 X=8 B=61 S=4/31 size=100x29",
