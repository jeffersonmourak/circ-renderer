...
export const TS_TODAY: Record<string, string> = {
  "and_of_not opaque": "and_of_not opaque I0=0 I1=0 I2=0 I3=0 X=2 B=10 S=0/4 size=37x9",
  "builtin_xnor expanded": "builtin_xnor expanded I0=0 I1=0 I2=0 I3=0 X=1 B=14 S=5/12 size=67x15",
  "builtin_xnor opaque": "builtin_xnor opaque I0=0 I1=0 I2=0 I3=0 X=0 B=4 S=1/3 size=32x9",
  "builtin_xor expanded": "builtin_xor expanded I0=0 I1=0 I2=0 I3=0 X=1 B=14 S=4/11 size=57x15",
  "builtin_xor opaque": "builtin_xor opaque I0=0 I1=0 I2=0 I3=0 X=0 B=4 S=1/3 size=31x9",
  "chain opaque": "chain opaque I0=0 I1=0 I2=0 I3=0 X=0 B=0 S=4/4 size=47x3",
  "clean_gated_feedback opaque": "clean_gated_feedback opaque I0=0 I1=0 I2=0 I3=0 X=0 B=4 S=1/2 size=22x4",
  "demux_1to2 opaque": "demux_1to2 opaque I0=0 I1=0 I2=0 I3=0 X=3 B=17 S=0/7 size=41x11",
  "demux_2bit_1to2 opaque": "demux_2bit_1to2 opaque I0=5 I1=2 I2=7 I3=0 X=4 B=31 S=1/13 size=42x21",
  "demux_3bit_1to2 opaque": "demux_3bit_1to2 opaque I0=10 I1=2 I2=13 I3=0 X=4 B=46 S=1/19 size=42x31",
  "edge_single_component opaque": "edge_single_component opaque I0=0 I1=0 I2=0 I3=0 X=0 B=4 S=1/2 size=23x7",
  "fan_in opaque": "fan_in opaque I0=0 I1=0 I2=0 I3=0 X=0 B=4 S=1/3 size=25x9",
  "fan_out opaque": "fan_out opaque I0=0 I1=0 I2=0 I3=0 X=0 B=4 S=4/6 size=26x11",
  "full_adder_from_builtins expanded": "full_adder_from_builtins expanded I0=0 I1=20 I2=17 I3=0 X=8 B=59 S=5/31 size=100x27",
  "full_adder_from_builtins opaque": "full_adder_from_builtins opaque I0=0 I1=0 I2=0 I3=0 X=5 B=24 S=1/12 size=64x15",
  "led_4bit_default opaque": "led_4bit_default opaque I0=0 I1=0 I2=0 I3=0 X=0 B=0 S=1/1 size=15x3",
  "mixed_width_preview opaque": "mixed_width_preview opaque I0=0 I1=0 I2=1 I3=0 X=1 B=9 S=0/3 size=42x7",
  "multi_led opaque": "multi_led opaque I0=0 I1=0 I2=0 I3=0 X=0 B=0 S=3/3 size=16x11",
  "multibit_and_preview opaque": "multibit_and_preview opaque I0=0 I1=0 I2=0 I3=0 X=0 B=4 S=1/3 size=30x9",
  ...
  "parallel_leftward_detours opaque": "parallel_leftward_detours opaque I0=0 I1=0 I2=0 I3=0 X=0 B=8 S=2/4 size=23x8",
  "ram_basic opaque": "ram_basic opaque I0=0 I1=5 I2=2 I3=0 X=0 B=8 S=1/5 size=39x21",
  "ram_write_read opaque": "ram_write_read opaque I0=0 I1=5 I2=2 I3=0 X=0 B=8 S=1/5 size=39x21",
  "regression_led_out_drives_gate opaque": "regression_led_out_drives_gate opaque I0=10 I1=0 I2=1 I3=0 X=3 B=9 S=1/4 size=32x9",
